...
if "cp_rank" in inspect.signature(dflash_speculator.prepare_dflash_inputs).parameters:
    dflash_speculator.prepare_dflash_inputs = prepare_dflash_inputs_ascend_dcp
else:
